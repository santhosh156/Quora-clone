 ...
 */
@Validated
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2019-02-06T16:03:42.520+05:30")
...
public class UserDeleteResponse {
    ...
    public UserDeleteResponse message(String id,String message) {
        this.id=id;
        this.message = message;
        return this;
    }

    @ApiModelProperty(required = true, value = "message for the deleted user")
    @NotNull
